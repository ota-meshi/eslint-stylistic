...
## [5.0.0-beta.4](https://github.com/ota-meshi/eslint-stylistic/compare/v5.0.0-beta.3...v5.0.0-beta.4) (2025-06-11)


### ⚠ BREAKING CHANGES

* handle TS object-like nodes in `object-curly-spacing` instead of `block-spacing` ([#822](https://github.com/ota-meshi/eslint-stylistic/issues/822))
* **space-before-function-paren:** handle catch clause with param ([#821](https://github.com/ota-meshi/eslint-stylistic/issues/821))
* **object-property-newline:** remove deprecated option ([#809](https://github.com/ota-meshi/eslint-stylistic/issues/809))
* v5: remove sub packages ([#794](https://github.com/ota-meshi/eslint-stylistic/issues/794))
* migrate to ESM-only, requires ESLint v9+ ([#670](https://github.com/ota-meshi/eslint-stylistic/issues/670))
* **indent-binary-ops:** remove unnecessary logic ([#645](https://github.com/ota-meshi/eslint-stylistic/issues/645))
* cross test `function-call-spacing` ([#565](https://github.com/ota-meshi/eslint-stylistic/issues/565))
* **comma-style:** turn off all exceptions option by default ([#602](https://github.com/ota-meshi/eslint-stylistic/issues/602))
* requires Node `^18.18.0 || ^20.9.0 || >=21.1.0`, bump deps ([#337](https://github.com/ota-meshi/eslint-stylistic/issues/337))

### Features

* add `module.exports` named export for `require(esm)` compatibility ([#700](https://github.com/ota-meshi/eslint-stylistic/issues/700)) ([668c955](https://github.com/ota-meshi/eslint-stylistic/commit/668c9556212423702dad4b73685c2299ece2527a))
...
* **comma-dangle:** add support for Import Attributes ([#586](https://github.com/ota-meshi/eslint-stylistic/issues/586)) ([4c177c3](https://github.com/ota-meshi/eslint-stylistic/commit/4c177c35057652e3872f65756fa62dc05b34cf93))
* **comma-style:** add support for more syntax ([#597](https://github.com/ota-meshi/eslint-stylistic/issues/597)) ([922151c](https://github.com/ota-meshi/eslint-stylistic/commit/922151c98b2dc75ad4a135f082050b9dd1b26d11))
* **comma-style:** turn off all exceptions option by default ([#602](https://github.com/ota-meshi/eslint-stylistic/issues/602)) ([c424d63](https://github.com/ota-meshi/eslint-stylistic/commit/c424d63eda46bc471d871d699b375d84ff3262bb))
* **configs:** add new severity option for all rules ([#733](https://github.com/ota-meshi/eslint-stylistic/issues/733)) ([#736](https://github.com/ota-meshi/eslint-stylistic/issues/736)) ([c553a9c](https://github.com/ota-meshi/eslint-stylistic/commit/c553a9ca745b8a46f1fc41986cde43da2d016431))
* **config:** update `yield-star-spacing` and `generator-star-spacing` config to align with Prettier ([86d17c8](https://github.com/ota-meshi/eslint-stylistic/commit/86d17c808df86abd89549b3554b793f71903d27b))
...
* cross test `function-call-spacing` ([#565](https://github.com/ota-meshi/eslint-stylistic/issues/565)) ([80ec2e4](https://github.com/ota-meshi/eslint-stylistic/commit/80ec2e4e3dc5c06e4c0837ac38b41bfad337bfe6))
...
* deprecate sub packages and emit warnings ([#793](https://github.com/ota-meshi/eslint-stylistic/issues/793)) ([48503aa](https://github.com/ota-meshi/eslint-stylistic/commit/48503aa38a932aedbcbe9e2b0003f477c0385286))
* **function-call-argument-newline:** add support for Import Attributes ([#603](https://github.com/ota-meshi/eslint-stylistic/issues/603)) ([8ee0c24](https://github.com/ota-meshi/eslint-stylistic/commit/8ee0c24da827c36da3df2e9724744b88fc3aa988))
* **function-call-spacing:** add `optionalChain` to control the space around the `optional chain` ([#605](https://github.com/ota-meshi/eslint-stylistic/issues/605)) ([f732798](https://github.com/ota-meshi/eslint-stylistic/commit/f73279887c755db71e47cb3248fea746fb34e783))
...
* **function-paren-newline:** add support for Import Attributes ([#585](https://github.com/ota-meshi/eslint-stylistic/issues/585)) ([4ede153](https://github.com/ota-meshi/eslint-stylistic/commit/4ede153af46af01ed3250e16365975e034631455))
* **generic-spacing:** remove spaces in type param instantiation ([#677](https://github.com/ota-meshi/eslint-stylistic/issues/677)) ([2a29e28](https://github.com/ota-meshi/eslint-stylistic/commit/2a29e2820116c5e728de9f15f324677e4240d25f))
* handle TS object-like nodes in `object-curly-spacing` instead of `block-spacing` ([#822](https://github.com/ota-meshi/eslint-stylistic/issues/822)) ([e9a4b80](https://github.com/ota-meshi/eslint-stylistic/commit/e9a4b80cc014be3df7141e0e005b284832126b44))
...
* **indent-binary-ops:** disabled to lower indent when starts closing bracket ([#591](https://github.com/ota-meshi/eslint-stylistic/issues/591)) ([25fe554](https://github.com/ota-meshi/eslint-stylistic/commit/25fe554cc19e0193e973dd4dd48ed5e218b5c6a5))
...
* **indent:** introduce `offsetTernaryExpressionsOffsetCallExpressions` options ([#636](https://github.com/ota-meshi/eslint-stylistic/issues/636)) ([c14a3ee](https://github.com/ota-meshi/eslint-stylistic/commit/c14a3eef1898c0ade0952208a4a470a6c6dd091f))
...
* **jsx-sort-props:** support custom reservedFirst and reservedLast ([#744](https://github.com/ota-meshi/eslint-stylistic/issues/744)) ([fb17e96](https://github.com/ota-meshi/eslint-stylistic/commit/fb17e9635a39873452a82e9e186af11966db679f))
...
* **key-spacing:** add ignoredNodes option ([#640](https://github.com/ota-meshi/eslint-stylistic/issues/640)) ([33ae1f6](https://github.com/ota-meshi/eslint-stylistic/commit/33ae1f6fbeb15f36967998fe566b74df7db8d3d5))
...
* migrate to ESM-only, requires ESLint v9+ ([#670](https://github.com/ota-meshi/eslint-stylistic/issues/670)) ([3145d50](https://github.com/ota-meshi/eslint-stylistic/commit/3145d5082191505f319e576cc30da51b907c380e))
* **no-extra-parens:** allow spread syntax to wrap parentheses ([#781](https://github.com/ota-meshi/eslint-stylistic/issues/781)) ([bc74e90](https://github.com/ota-meshi/eslint-stylistic/commit/bc74e9081b06a6ee2e695b1016b35289f0941976))
* **no-extra-parens:** introduce `nestedConditionalExpressions` option ([#657](https://github.com/ota-meshi/eslint-stylistic/issues/657)) ([bf63800](https://github.com/ota-meshi/eslint-stylistic/commit/bf63800c49218d554c79b4da6513c8ef90f59857))
...
* **object-property-newline:** remove deprecated option ([#809](https://github.com/ota-meshi/eslint-stylistic/issues/809)) ([30614af](https://github.com/ota-meshi/eslint-stylistic/commit/30614af0e865c3dd6ff0c1d8d9d8407619d4d263))
* **operator-linebreak:** support TS Nodes ([#805](https://github.com/ota-meshi/eslint-stylistic/issues/805)) ([d7ab8d2](https://github.com/ota-meshi/eslint-stylistic/commit/d7ab8d226dcf8a3962c91d036ead4dbfc33c7e99))
* **padded-blocks:** add start and end options ([#655](https://github.com/ota-meshi/eslint-stylistic/issues/655)) ([cf49939](https://github.com/ota-meshi/eslint-stylistic/commit/cf49939a716a8f66f2d5be1d043a7c736133a986))
...
* **quotes:** Option to allow template literals only to avoid escape ([#643](https://github.com/ota-meshi/eslint-stylistic/issues/643)) ([5558bdb](https://github.com/ota-meshi/eslint-stylistic/commit/5558bdbb2eb989b81bf7b91c62d5e9f1c80bb822))
...
* **semi-spacing:** support handling typescript ([#687](https://github.com/ota-meshi/eslint-stylistic/issues/687)) ([8b76c93](https://github.com/ota-meshi/eslint-stylistic/commit/8b76c931178b705523bb130eb2d8e154071ea7ff))
* **space-before-function-paren:** handle catch clause with param ([#821](https://github.com/ota-meshi/eslint-stylistic/issues/821)) ([64c0607](https://github.com/ota-meshi/eslint-stylistic/commit/64c0607767a4a5022d8ce3a5b5bb346c48ec5dd4))
* **space-infix-ops:** allow to ignore types in ts variant ([#684](https://github.com/ota-meshi/eslint-stylistic/issues/684)) ([c83ce20](https://github.com/ota-meshi/eslint-stylistic/commit/c83ce20633966e6abfc181ee667ff4a9ea7d8c79))
...
* **type-generic-spacing:** remove whitespaces in generic types ([#667](https://github.com/ota-meshi/eslint-stylistic/issues/667)) ([8dd68e2](https://github.com/ota-meshi/eslint-stylistic/commit/8dd68e2c7dd6720ce2c0e6fcdbe9c0573c3a1eda))
* v5: remove sub packages ([#794](https://github.com/ota-meshi/eslint-stylistic/issues/794)) ([3b2fd6e](https://github.com/ota-meshi/eslint-stylistic/commit/3b2fd6e09650aefc96ba7a8006012eac9a75d96f))
...
* **comma-style:** handles comma after default import and trailing comma ([#600](https://github.com/ota-meshi/eslint-stylistic/issues/600)) ([2d8d8ce](https://github.com/ota-meshi/eslint-stylistic/commit/2d8d8ce57a12b597de1cffab8e9784b8e20fca15))
...
* **deps:** unpin typescript-eslint deps ([#673](https://github.com/ota-meshi/eslint-stylistic/issues/673)) ([9fb672d](https://github.com/ota-meshi/eslint-stylistic/commit/9fb672df83c5138a3f521f281e37babb307606bc))
* **eslint-plugin:** only export interfaces in index ([#763](https://github.com/ota-meshi/eslint-stylistic/issues/763)) ([93a4eb1](https://github.com/ota-meshi/eslint-stylistic/commit/93a4eb1a55615dce0cf86f3124ac6aa891b5bd8a))
* fix the `update` script in `Windows` ([#604](https://github.com/ota-meshi/eslint-stylistic/issues/604)) ([dede119](https://github.com/ota-meshi/eslint-stylistic/commit/dede11938e3e15a9e36efefeb548eaa1f3cb1484))
...
* **function-call-spacing:** remove invalid defaults from schema ([#617](https://github.com/ota-meshi/eslint-stylistic/issues/617)) ([0714754](https://github.com/ota-meshi/eslint-stylistic/commit/07147543dad01ecdf99ebb17b00384f134926bc5))
* handle new AST change on `TSImportType` ([8f31461](https://github.com/ota-meshi/eslint-stylistic/commit/8f31461f22f6d59836705ddeb5713129b118d50c))
* **indent-binary-ops:** correctly handle `TypeAliasDeclaration` ([#647](https://github.com/ota-meshi/eslint-stylistic/issues/647)) ([ca2aabc](https://github.com/ota-meshi/eslint-stylistic/commit/ca2aabc52a9d219cd16889cc9c4ea8b04d6af054))
* **indent-binary-ops:** handle `{` for left token check ([#693](https://github.com/ota-meshi/eslint-stylistic/issues/693)) ([7f2740e](https://github.com/ota-meshi/eslint-stylistic/commit/7f2740e824b621c07fe373f81bdd7dac093f2422))
...
* **indent-binary-ops:** indent on multiline assignment ([#644](https://github.com/ota-meshi/eslint-stylistic/issues/644)) ([d708587](https://github.com/ota-meshi/eslint-stylistic/commit/d7085874e84d7113a140878650f90f4efae87766))
* **indent:** consider `CallExpression` when `offsetTernaryExpressions` is true ([#625](https://github.com/ota-meshi/eslint-stylistic/issues/625)) ([55d3529](https://github.com/ota-meshi/eslint-stylistic/commit/55d3529bd8da0d5d944e0647713a8afa17296639))
...
* **indent:** correctly ignore `JSXText` and TS nodes ([#785](https://github.com/ota-meshi/eslint-stylistic/issues/785)) ([b0b4218](https://github.com/ota-meshi/eslint-stylistic/commit/b0b4218a4534ea14ea458f50fde2665f1a5757a7))
* **indent:** handle `ChainExpression` and `AwaitExpression` when `offsetTernaryExpressionsOffsetCallExpressions` ([#751](https://github.com/ota-meshi/eslint-stylistic/issues/751)) ([a1af663](https://github.com/ota-meshi/eslint-stylistic/commit/a1af6635dce41dbea7ae7abcae037e40dee667b7))
...
* **indent:** wrong PropertyDefinition value offset when ts type have multiple line ([#774](https://github.com/ota-meshi/eslint-stylistic/issues/774)) ([140e18f](https://github.com/ota-meshi/eslint-stylistic/commit/140e18f3fc18a99e3e38f05d99eea6776b284938))
...
* **jsx-sort-props:** correct option schema ([#801](https://github.com/ota-meshi/eslint-stylistic/issues/801)) ([f80f38a](https://github.com/ota-meshi/eslint-stylistic/commit/f80f38a9d68d9f98b6a32329b94ce8a5f61a58f7))
* **jsx-wrap-multilines:** prevent crash when using tabs ([#653](https://github.com/ota-meshi/eslint-stylistic/issues/653)) ([8cbc9f8](https://github.com/ota-meshi/eslint-stylistic/commit/8cbc9f85d6b8b75acb3eac6e606d2361cc1d2af6))
* **jsx-wrap-multilines:** text between replacement texts included in parentheses ([#618](https://github.com/ota-meshi/eslint-stylistic/issues/618)) ([0764252](https://github.com/ota-meshi/eslint-stylistic/commit/07642521b779636a9580d5236a0e03fceaa74d58))
* **key-spacing:** crash for import without attributes when using `align: "colon"` ([#594](https://github.com/ota-meshi/eslint-stylistic/issues/594)) ([6000f43](https://github.com/ota-meshi/eslint-stylistic/commit/6000f43d0d6522af1616192321a84cb2ead9b95d))
* **keyword-spacing:** check spaces around the `type` keyword in `export` declarations ([#797](https://github.com/ota-meshi/eslint-stylistic/issues/797)) ([6854a3c](https://github.com/ota-meshi/eslint-stylistic/commit/6854a3c832a35397d1b5a558c85508f6edef18d8))
...
* metadata path generate normalize ([#820](https://github.com/ota-meshi/eslint-stylistic/issues/820)) ([7c6d6ef](https://github.com/ota-meshi/eslint-stylistic/commit/7c6d6ef3a7490dc2fed4345b15d353babc2db704))
...
* **no-extra-parens:** do not break specific `ReturnStatement` ([#738](https://github.com/ota-meshi/eslint-stylistic/issues/738)) ([a375a92](https://github.com/ota-meshi/eslint-stylistic/commit/a375a92fefe3905ba46961e3278cc80cdf3ba050))
...
* **plus:** dependencies bundle ([ba9ed81](https://github.com/ota-meshi/eslint-stylistic/commit/ba9ed81029c7cc06a38a36f16faf443138bd4800))
...
* add `flat: true` to flat config customize example ([#669](https://github.com/ota-meshi/eslint-stylistic/issues/669)) ([4710771](https://github.com/ota-meshi/eslint-stylistic/commit/4710771c11548a4b854c89188351d0d4a1b27fd7))
...
* cleanup outdated information ([#818](https://github.com/ota-meshi/eslint-stylistic/issues/818)) ([33d0edd](https://github.com/ota-meshi/eslint-stylistic/commit/33d0edd9dd6576130f1cd3208db8ca88bb56dd64))
* correct eslint flat config in migration guide ([#634](https://github.com/ota-meshi/eslint-stylistic/issues/634)) ([16a0ae0](https://github.com/ota-meshi/eslint-stylistic/commit/16a0ae0b181230007ca7b80c1eb60b13e79a1ac2))
* deprecate `jsx-indent` ([#741](https://github.com/ota-meshi/eslint-stylistic/issues/741)) ([ca23ce1](https://github.com/ota-meshi/eslint-stylistic/commit/ca23ce1ef0063f946e4defbf4118edc4eae49748))
...
* fix comment example ([#759](https://github.com/ota-meshi/eslint-stylistic/issues/759)) ([c841bb6](https://github.com/ota-meshi/eslint-stylistic/commit/c841bb6fe72fd13a1db28e21580a1056036d25fe))
* fix eslint error ([#775](https://github.com/ota-meshi/eslint-stylistic/issues/775)) ([f2866f9](https://github.com/ota-meshi/eslint-stylistic/commit/f2866f9120fa73c5ed98e501364fdd3948cabd82))
* fix eslint error tip does not display ([#792](https://github.com/ota-meshi/eslint-stylistic/issues/792)) ([b09756d](https://github.com/ota-meshi/eslint-stylistic/commit/b09756de4061e249dc34c424948be9a53dbed821))
* fix incorrect breadcrumbs ([#642](https://github.com/ota-meshi/eslint-stylistic/issues/642)) ([eea9267](https://github.com/ota-meshi/eslint-stylistic/commit/eea92676326d26ec3786d2e2ee842507678fb565))
...
* incorrect error tip should display ([#747](https://github.com/ota-meshi/eslint-stylistic/issues/747)) ([7e06b81](https://github.com/ota-meshi/eslint-stylistic/commit/7e06b8118c563e7ab0e7b99bd1f579249e3b5de9))
* **indent:** fix incorrect option description ([#638](https://github.com/ota-meshi/eslint-stylistic/issues/638)) ([d427d47](https://github.com/ota-meshi/eslint-stylistic/commit/d427d47c430b5d9db90349438eaaa2c30b083511))
...
* redirect sub packages links ([#811](https://github.com/ota-meshi/eslint-stylistic/issues/811)) ([3a6aff2](https://github.com/ota-meshi/eslint-stylistic/commit/3a6aff2ae24c8cc7367f311d008e5dc7e9dc896d))
* remove legacy config option, close [#703](https://github.com/ota-meshi/eslint-stylistic/issues/703) ([de8369e](https://github.com/ota-meshi/eslint-stylistic/commit/de8369e3d9b85055014562c6055c5bf6e801dba1))
* support eslint v9 parser ([#631](https://github.com/ota-meshi/eslint-stylistic/issues/631)) ([0e4b1cb](https://github.com/ota-meshi/eslint-stylistic/commit/0e4b1cbd6df7f7ef45f99c5fe4bfc99bb595f009))
...
* typo ([#662](https://github.com/ota-meshi/eslint-stylistic/issues/662)) ([a87f5bd](https://github.com/ota-meshi/eslint-stylistic/commit/a87f5bd4e6428b5887359b5e793d36fbdd9376a0))
* typo ([#723](https://github.com/ota-meshi/eslint-stylistic/issues/723)) ([b6ed751](https://github.com/ota-meshi/eslint-stylistic/commit/b6ed75158336a3253378b6312c5311ebbd139bcb))
* update links ([f80db20](https://github.com/ota-meshi/eslint-stylistic/commit/f80db20d67d2f796655fd83de370609e21fa701f))
* update merged note ([07b08f1](https://github.com/ota-meshi/eslint-stylistic/commit/07b08f1c7d74de0fe2cb6886b4f49baae574a71b))
...
* **deps:** bump codecov/codecov-action from 4 to 5 ([#612](https://github.com/ota-meshi/eslint-stylistic/issues/612)) ([047a384](https://github.com/ota-meshi/eslint-stylistic/commit/047a3840e43bea3731c5bef629e18a06b10c55a8))
...
* `comma-dangle` ([#716](https://github.com/ota-meshi/eslint-stylistic/issues/716)) ([7e55b16](https://github.com/ota-meshi/eslint-stylistic/commit/7e55b1645d228ee7471bfdd71ff92bf9a7a0cd16))
...
* cross test `indent` ([#563](https://github.com/ota-meshi/eslint-stylistic/issues/563)) ([80c5486](https://github.com/ota-meshi/eslint-stylistic/commit/80c5486682a1ff3ecea525cdf4e3d27d0e2a0bb8))
...
* **indent-binary-ops:** remove unnecessary logic ([#645](https://github.com/ota-meshi/eslint-stylistic/issues/645)) ([a06ed18](https://github.com/ota-meshi/eslint-stylistic/commit/a06ed180b4b5a09d7bd0f2e06eff76b70f265546))
* **indent-binary-ops:** use unified testing tool ([#806](https://github.com/ota-meshi/eslint-stylistic/issues/806)) ([3a8fc53](https://github.com/ota-meshi/eslint-stylistic/commit/3a8fc53f5b05c23ecd0665c8ce4c2e6d5e94dd96))
...
* merge `block-spacing` ([#690](https://github.com/ota-meshi/eslint-stylistic/issues/690)) ([b239b71](https://github.com/ota-meshi/eslint-stylistic/commit/b239b717bb6dc9eb0632ce9d3bb3379501b72471))
* merge `brace-style` ([#715](https://github.com/ota-meshi/eslint-stylistic/issues/715)) ([5769933](https://github.com/ota-meshi/eslint-stylistic/commit/5769933da4c402fd54a59cfeb664f172c27948eb))
* merge `indent` ([#713](https://github.com/ota-meshi/eslint-stylistic/issues/713)) ([a57c2bb](https://github.com/ota-meshi/eslint-stylistic/commit/a57c2bb27226d5daf3098f09444ff91de2338084))
* merge `key-spacing` ([#734](https://github.com/ota-meshi/eslint-stylistic/issues/734)) ([99c0873](https://github.com/ota-meshi/eslint-stylistic/commit/99c0873f74464bff90f148efb8d4282a042956a0))
* merge `keyword-spacing` ([#732](https://github.com/ota-meshi/eslint-stylistic/issues/732)) ([0018519](https://github.com/ota-meshi/eslint-stylistic/commit/001851960ad5cf7e2490aa097655202dde2a80ba))
* merge `lines-around-comment` ([#691](https://github.com/ota-meshi/eslint-stylistic/issues/691)) ([f59605b](https://github.com/ota-meshi/eslint-stylistic/commit/f59605b9d1967357e9507998b0f7649c20094d55))
* merge `lines-between-class-members` ([#730](https://github.com/ota-meshi/eslint-stylistic/issues/730)) ([9f4bda0](https://github.com/ota-meshi/eslint-stylistic/commit/9f4bda0044d3ccb760eba65467a2062349c4409e))
* merge `no-extra-parens` ([#711](https://github.com/ota-meshi/eslint-stylistic/issues/711)) ([d6809c9](https://github.com/ota-meshi/eslint-stylistic/commit/d6809c910510a4477e01ea248071f0701d0af4ed))
* merge `no-extra-semi` ([#731](https://github.com/ota-meshi/eslint-stylistic/issues/731)) ([880814e](https://github.com/ota-meshi/eslint-stylistic/commit/880814e49fae4f25d1ff58204348427e65609714))
* merge `object-property-newline` ([#719](https://github.com/ota-meshi/eslint-stylistic/issues/719)) ([d49ef91](https://github.com/ota-meshi/eslint-stylistic/commit/d49ef91e765938c60e2b344391a0d5a09c85bdc1))
* merge `quote-props` ([#729](https://github.com/ota-meshi/eslint-stylistic/issues/729)) ([e5b09a5](https://github.com/ota-meshi/eslint-stylistic/commit/e5b09a52c1501295de96fa95e97b91d4ffeadddd))
* merge `quotes` ([#720](https://github.com/ota-meshi/eslint-stylistic/issues/720)) ([9284830](https://github.com/ota-meshi/eslint-stylistic/commit/9284830c2b816c66b8ae50bd4e0c0ecff1ad555e))
* merge `semi-spacing` ([#727](https://github.com/ota-meshi/eslint-stylistic/issues/727)) ([72856a8](https://github.com/ota-meshi/eslint-stylistic/commit/72856a876c64071cc68e9437562ec2422dfd39f6))
* merge `semi` ([#728](https://github.com/ota-meshi/eslint-stylistic/issues/728)) ([85eeaa1](https://github.com/ota-meshi/eslint-stylistic/commit/85eeaa16f102190f04801a8bfa9675f6638b51a4))
* merge `space-before-blocks` ([#698](https://github.com/ota-meshi/eslint-stylistic/issues/698)) ([6e8554d](https://github.com/ota-meshi/eslint-stylistic/commit/6e8554dbcb4dc87814c7131d3a235f3c68dee16e))
* merge `space-infix-ops` ([#697](https://github.com/ota-meshi/eslint-stylistic/issues/697)) ([1a1b388](https://github.com/ota-meshi/eslint-stylistic/commit/1a1b3886c42baeb15f113a8129256d1e0d9c23a6))
* merge object-curly-newline ([#717](https://github.com/ota-meshi/eslint-stylistic/issues/717)) ([0d3e33b](https://github.com/ota-meshi/eslint-stylistic/commit/0d3e33bda279dfc532efd4f6cafeb0b1881a3f9e))
* merge object-curly-spacing ([#718](https://github.com/ota-meshi/eslint-stylistic/issues/718)) ([d943ef0](https://github.com/ota-meshi/eslint-stylistic/commit/d943ef0c41a59ad361a2e14ea80058c3c0f9a2a6))
...
* **one-var-declaration-per-line:** use replace string insert `\n` ([#705](https://github.com/ota-meshi/eslint-stylistic/issues/705)) ([48181b5](https://github.com/ota-meshi/eslint-stylistic/commit/48181b51e4c7309b8efc73de7a993e709faa8770))
* **quotes:** add some test cases ([a7f7c2a](https://github.com/ota-meshi/eslint-stylistic/commit/a7f7c2a900223570586740763487b674644560e2))
* release-please-mark ([4ead7ab](https://github.com/ota-meshi/eslint-stylistic/commit/4ead7abf53b752d35db28e910e6fe31cd9913734))
* release-please-mark ([d99936f](https://github.com/ota-meshi/eslint-stylistic/commit/d99936f4667ac2d8710db526e4dd7328aaccb396))
* release-please-mark ([4a689f1](https://github.com/ota-meshi/eslint-stylistic/commit/4a689f178dc62de258580aa4267e9a134eefb8ea))
* release-please-mark ([b894a75](https://github.com/ota-meshi/eslint-stylistic/commit/b894a75f8d38ab9af6ae419d69447a2de0ff337e))
* release-please-mark ([100a4fd](https://github.com/ota-meshi/eslint-stylistic/commit/100a4fd52a097ba9487b43c5e4c3fff222094a1e))
* release-please-mark ([e9ca882](https://github.com/ota-meshi/eslint-stylistic/commit/e9ca88292b0c137226dadfbfa77bf9d73584802b))
* release-please-mark ([ceff702](https://github.com/ota-meshi/eslint-stylistic/commit/ceff702a78e6abc0f714714fedfab3100d2f5625))
* release-please-mark ([5e7a284](https://github.com/ota-meshi/eslint-stylistic/commit/5e7a2841f226347c853559a58c3601d369b8a1ad))
* release-please-mark ([08b65a5](https://github.com/ota-meshi/eslint-stylistic/commit/08b65a5a605f4e86808983275370271548e98ec9))
...
* remove unnecessary ternary expression ([#695](https://github.com/ota-meshi/eslint-stylistic/issues/695)) ([66a4b18](https://github.com/ota-meshi/eslint-stylistic/commit/66a4b18d46979a1a51e350a0f547d28900a078dc))
* replace deprecated `isSpaceBetweenTokens` with `isSpaceBetween` ([#646](https://github.com/ota-meshi/eslint-stylistic/issues/646)) ([6da7c42](https://github.com/ota-meshi/eslint-stylistic/commit/6da7c42da0633ad9c8156910200c592cbe888a30))
...
* **type-generic-spacing:** unify spacing checks ([#800](https://github.com/ota-meshi/eslint-stylistic/issues/800)) ([6f8b01c](https://github.com/ota-meshi/eslint-stylistic/commit/6f8b01c550383d631d1da5d5e3919a29fb9a593b))
...
* use `RuleOptions` and `MessageIds` generic type ([#742](https://github.com/ota-meshi/eslint-stylistic/issues/742)) ([ace84e3](https://github.com/ota-meshi/eslint-stylistic/commit/ace84e3f15ec50443f250106aedbb5e38af4b5bd))
